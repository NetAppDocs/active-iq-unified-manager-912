...
*	Operating system: Red Hat Enterprise Linux versions 7.x and from 8.0 to 8.6, or CentOS version 7.x based on x86_64 architecture, installed using the “Server with GUI” base environment from the *Software Selection* option of the OS installer
